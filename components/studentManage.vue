...
<!--          </el-form-item>-->
<!--          <el-form-item>-->
            <el-button type="success" @click="handleAdd" icon="el-icon-plus">添加学生</el-button>
          </el-form-item>
          <!--          <el-form-item>-->
      ...
      <el-table :data="tableData" border ref="multipleTable" tooltip-effect="dark" >
        <el-table-column prop="studentID" label="学生id" width="140" sortable>
        </el-table-column>
        <el-table-column prop="name" label="学生姓名" width="140" sortable>
        </el-table-column>
        ...
        <el-table-column prop="classID" label="班级" sortable show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="majorname" label="专业名" width="140" sortable>
        </el-table-column>
        <el-table-column prop="departmentname" label="系名" width="140" sortable>
        </el-table-column>
      ...
      <el-dialog title="添加学生" :visible.sync="dialogVisible"  width="35%">
        <el-form ref="addGrad" :model="addGrad" label-width="80px" :rules="rules">
          ...
          <el-form-item  label="班级id" prop="name">
            <el-input v-model="addGrad.classID"></el-input>
          </el-form-item>
          ...
          <el-form-item label="专业">
            <el-input  v-model="addGrad.majorname"></el-input>
          </el-form-item>
          <el-form-item label="密码">
            <el-input  v-model="addGrad.password"></el-input>
          </el-form-item>
        </el-form>
...
<script>
  ...
  export default {
    ...
    mounted(){
      ...
      this.$ajax.get("http://10.28.255.88:5000/app/admin/allstudentlist",
        {
          params:{},
          headers:{
    ...
    methods: {
      addSubmit(){
        this.$ajax.post("http://10.28.255.88:5000/app/admin/student",{
      ...
      handleDel: function (index, row) {
        this.$confirm('确认删除该记录吗?', '提示', {
          type: 'warning'
            ...
            this.$ajax.delete("http://10.28.255.88:5000/app/admin/student",{
          params:{
                UUID:this.tableData[row].userID
              },
                headers:{
                  "Authorization":"Bearer "+this.userinfo.token
                }}
